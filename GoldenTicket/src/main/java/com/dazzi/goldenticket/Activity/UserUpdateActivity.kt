...
import com.dazzi.goldenticket.DB.SharedPreferenceController.getUserEmail
import com.dazzi.goldenticket.DB.SharedPreferenceController.getUserName
import com.dazzi.goldenticket.DB.SharedPreferenceController.getUserPhone
...
class UserUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.dazzi.goldenticket.R.layout.activity_user_update)
    ...
    private fun isDataVaild() {
        et_userupdate_name.onFocusChangeListener = View.OnFocusChangeListener { v, hasFocus ->
            if (hasFocus || et_userupdate_name.text.toString() != "") v.setBackgroundResource(com.dazzi.goldenticket.R.drawable.underline_yellow)
        ...
        et_userupdate_email.onFocusChangeListener = View.OnFocusChangeListener { v, hasFocus ->
            if (hasFocus || et_userupdate_email.text.toString() != "") v.setBackgroundResource(com.dazzi.goldenticket.R.drawable.underline_yellow)
            else v.setBackgroundResource(com.dazzi.goldenticket.R.drawable.underline_white)
        }
        et_userupdate_phone.onFocusChangeListener = View.OnFocusChangeListener { v, hasFocus ->
            if (hasFocus || et_userupdate_phone.text.toString() != "") v.setBackgroundResource(com.dazzi.goldenticket.R.drawable.underline_yellow)
            else v.setBackgroundResource(com.dazzi.goldenticket.R.drawable.underline_white)
        }
    }
